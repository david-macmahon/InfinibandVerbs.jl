...
export Context, get_device_names, get_device_guids, req_notify_send_cq,
       req_notify_recv_cq, get_qp_state, modify_qp_state, transition_qp_to_rts,
       transition_qp_to_rtr, wait_for_completion_event,
       wait_for_send_completion_event, wait_for_recv_completion_event,
       query_device, query_device_ex, query_port, hascapability
